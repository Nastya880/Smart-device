...
var _aboutCompany = require("./modules/about-company");
var _smoothScroll = require("./modules/smooth-scroll");
var _modalFeedback = require("./modules/modals/modal-feedback");
var _accordion = require("./modules/accordion");
var _phoneMask = require("./modules/phone-mask.js");
var _focusDataName = require("./modules/focus-data-name.js");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _aboutCompany.readMoreInfoCompany)(_aboutCompany.dopContent, _aboutCompany.aboutCompanyButton);
  (0, _smoothScroll.smoothScroll)(_smoothScroll.introButton, _smoothScroll.sectionFeedback);

  // Modules
  // ---------------------------------

  (0, _accordion.showAccordion)(_accordion.accordionButton, _accordion.accordionElement);
  (0, _focusDataName.addFocus)(_focusDataName.btnOpenModal, _focusDataName.inputForFocus);
  (0, _phoneMask.addPhoneMask)();
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _modalFeedback.showModalFeedback)();
  });
});
...
},{"./modules/about-company":2,"./modules/accordion":3,"./modules/focus-data-name.js":4,"./modules/form-validate/form":6,"./modules/modals/init-modals":12,"./modules/modals/modal-feedback":13,"./modules/phone-mask.js":15,"./modules/smooth-scroll":16,"./utils/ios-vh-fix":19}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.readMoreInfoCompany = exports.dopContent = exports.aboutCompanyButton = void 0;
var aboutCompanyButton = exports.aboutCompanyButton = document.querySelector('[data-about-company-button]');
var dopContent = exports.dopContent = document.querySelectorAll('[data-about-company__more-info]');
aboutCompanyButton.classList.remove('is-without-js');
dopContent.forEach(function (content) {
  return content.classList.remove('is-without-js');
});
var readMoreInfoCompany = exports.readMoreInfoCompany = function readMoreInfoCompany(dopContents, buttonForMoreContent) {
  dopContents.forEach(function (content) {
    return content.classList.add('is-hidden');
  });
  buttonForMoreContent.addEventListener('click', function () {
    dopContents.forEach(function (content) {
      return content.classList.toggle('is-hidden');
    });
...
exports.showAccordion = exports.accordionElement = exports.accordionButton = void 0;
var accordionButton = exports.accordionButton = document.querySelectorAll('[data-accordion-button]');
var accordionElement = exports.accordionElement = document.querySelectorAll('[data-accordion-container]');
var showAccordion = exports.showAccordion = function showAccordion(buttons, elements) {
  if (elements) {
...
exports.inputForFocus = exports.btnOpenModal = exports.addFocus = void 0;
var btnOpenModal = exports.btnOpenModal = document.querySelector('[data-modal="open-modal"]');
var inputForFocus = exports.inputForFocus = document.querySelector('[data-name]');
var addFocus = exports.addFocus = function addFocus(btnOpenModalWindow, input) {
...
},{"./modals":14}],13:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showModalFeedback = void 0;
var modal = document.querySelector('[data-modal="feedback-form"]');
var overlay = document.querySelector('[data-modal="overlay"]');
var openModalBtn = document.querySelector('[data-modal="open-modal"]');
var closeModalBtn = document.querySelector('[data-modal="close-modal"]');
var showModalFeedback = exports.showModalFeedback = function showModalFeedback() {
...
exports.addPhoneMask = void 0;
var _initPhoneInput = require("./form-validate/init-phone-input.js");
var addPhoneMask = exports.addPhoneMask = function addPhoneMask() {
  var inputNumbersPhone = document.querySelectorAll('[data-number-phone]');
  inputNumbersPhone.forEach(function (inputNumberPhone) {
    (0, _initPhoneInput.initPhoneInput)(inputNumberPhone);
  });
};

},{"./form-validate/init-phone-input.js":7}],16:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.smoothScroll = exports.sectionFeedback = exports.introButton = void 0;
var introButton = exports.introButton = document.querySelector('.intro__button');
var sectionFeedback = exports.sectionFeedback = document.querySelector('.feedback');
var smoothScroll = exports.smoothScroll = function smoothScroll(buttonForScroll, sectionResult) {
